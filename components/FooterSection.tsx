...
export default function FooterSection() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Row 1: Two columns — Tech Stack + Contact */}
        <motion.div
        ...
        >
          ...
          <div className="wrapper-column">
            <h3
              ...
              style={{ color: "#8C8072", fontSize: "11px", letterSpacing: "0.08em", textTransform: "uppercase" }}
            >
          ...
          <div className="wrapper-column right">
            <h3
              className="font-medium mb-3 md:text-right"
              style={{ color: "#8C8072", fontSize: "11px", letterSpacing: "0.08em", textTransform: "uppercase" }}
            >
              &ldquo;Contact:&rdquo;
            </h3>
        ...
        >
          <h2
            className="font-bold text-cream leading-none"
            style={{
        ...
        >
          <h3 style={{ color: "#8C8072", fontSize: "12px", fontWeight: 500 }}>
            Freelance Design Director{" "}
            <span style={{ color: "rgba(245,237,227,0.35)" }}>2026</span>
          </h3>
          <h3 style={{ color: "#8C8072", fontSize: "12px", fontWeight: 500 }}>
            Morable Design Studio{" "}
            <span style={{ color: "rgba(245,237,227,0.35)" }}>[Coming Soon]</span>
          </h3>
        </motion.div>
      </div>
    </section>
